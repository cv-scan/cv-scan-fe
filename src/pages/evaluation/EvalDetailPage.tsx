      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Card padding={false}>
          <div className="p-5">
            ...
            <Link
              to={`/jd/${evaluation.jobDescriptionId}`}
              className="inline-flex items-center gap-1.5 font-semibold text-gray-900 text-sm hover:text-red-500 transition-colors"
            >
              <span className="truncate">
                {evaluation.jdTitle ||
                  evaluation.jobDescription?.title ||
                  `JD #${evaluation.jobDescriptionId.slice(0, 8)}`}
              </span>
              <svg
        ...
        <Card padding={false}>
          <div className="p-5">
            ...
            <Link
              to={`/cv/${evaluation.cvId}`}
              className="inline-flex items-center gap-1.5 font-semibold text-gray-900 text-sm hover:text-red-500 transition-colors"
            >
              <span className="truncate">
                {evaluation.candidateName ||
                  evaluation.cv?.parsedData?.name ||
                  evaluation.cv?.fileName ||
                  `CV #${evaluation.cvId.slice(0, 8)}`}
              </span>
              <svg
                className="h-3.5 w-3.5 shrink-0"
                fill="none"
          ...
          <div className="p-5 flex items-center gap-4">
            ...
            <div>
              <p className="font-semibold text-red-900 text-sm">
                AI is evaluating the CV...
              </p>
              <p className="text-sm text-red-500 mt-0.5">
                Results will appear shortly. Page auto-refreshes.
              </p>
            </div>
          </div>
        </Card>
