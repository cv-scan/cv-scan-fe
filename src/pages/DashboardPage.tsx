...
function StatCard({ label, value, href, icon, color }: StatCardProps) {
  return (
    <Link to={href}>
      <Card className="hover:shadow-md transition-all duration-200 cursor-pointer group" padding={false}>
        <div className="p-6">
          <div className="flex items-start justify-between">
            ...
            <div className={`h-11 w-11 rounded-xl ${color} flex items-center justify-center group-hover:scale-110 transition-transform`}>
              {icon}
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">Here's an overview of your CV scan activity.</p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card padding={false}>
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                ...
                <Link to="/evaluations" className="text-sm text-red-500 hover:text-red-600 font-medium">
                  View all
                </Link>
              </div>
              {recentEvals.length === 0 ? (
                <div className="text-center py-10 px-6">
                  ...
                  <Link to="/evaluations" className="text-red-500 text-sm hover:text-red-600 font-medium mt-1 inline-block">
              ...
              <div className="p-4 space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Create a new JD to evaluate CVs against</p>
                  </div>
                  <svg className="h-4 w-4 text-gray-300 ml-auto group-hover:text-red-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Upload a PDF or DOCX resume</p>
                  </div>
                  <svg className="h-4 w-4 text-gray-300 ml-auto group-hover:text-violet-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </Link>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Score a CV against a job description</p>
                  </div>
                  <svg className="h-4 w-4 text-gray-300 ml-auto group-hover:text-emerald-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </Link>
              </div>
