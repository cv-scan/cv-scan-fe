...
function AuthModal({
  ...
  const handleSwitchMode = (nextMode: ModalMode) => {
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Senior Frontend Engineer · nguyen_van_a_cv.pdf
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-3.5">
              ...
              <p className="text-xs text-gray-600 leading-relaxed line-clamp-3">
                Strong match for the role. Candidate demonstrates solid skills
                across required areas with relevant experience.
              </p>
            </div>
          </div>
        </div>
...
function CVListMockup() {
  const cvs = [
    ...
    {
      name: "tran_thi_b_resume.pdf",
      candidate: "Tran Thi B",
      status: "Parsed",
      color: "text-green-600 bg-green-50 border-green-100",
    },
    {
      name: "le_van_c_cv.docx",
      candidate: "Le Van C",
      status: "Processing",
      ...
      <div className="flex h-72">
        ...
        <div className="flex-1 bg-gray-50 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-xs bg-red-500 text-white px-3 py-1 rounded-lg font-medium">
              Upload CV
            </div>
          </div>
          <div className="space-y-2">
            {cvs.map((cv) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-medium px-2 py-0.5 rounded-full border ${cv.color}`}
                >
                  {cv.status}
                </span>
              </div>
...
const steps = [
  {
    ...
    desc: "Create a JD and relevant skills will be extracted automatically.",
  },
  {
    num: "02",
    title: "Upload Candidate CVs",
    desc: "Upload PDF or DOCX files. Candidate data is parsed and structured.",
  },
  {
    num: "03",
    title: "Run an Evaluation",
    desc: "Select a JD and a CV, then start the evaluation with one click.",
  },
  {
    num: "04",
    title: "Review Results",
    desc: "Get scores, written feedback, and a final hire/no-hire recommendation.",
  },
];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="max-w-2xl mb-14">
            ...
            <p className="mt-5 text-lg text-gray-500 leading-relaxed">
              Upload CVs, match them against job descriptions, and get detailed
              scores with written feedback and a clear recommendation.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-500 mt-4 leading-relaxed">
                Upload resumes in bulk, track parsing status, and access
                candidate profiles at a glance. No more digging through email
                attachments.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">
              From CV upload to final recommendation — a complete screening
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3">
              Four steps to a complete candidate evaluation
            </p>
          </div>
      ...
      <footer className="border-t border-gray-100 py-7 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} CV Scan. All rights reserved.
          </p>
